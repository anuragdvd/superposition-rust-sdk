...
------------- | ------------- | -------------
[**applicable_variants**](DefaultApi.md#applicable_variants) | **GET** /experiments/v2/applicable-variants | 
[**bulk_operation**](DefaultApi.md#bulk_operation) | **PUT** /context/bulk-operations | 
...
[**get_config**](DefaultApi.md#get_config) | **POST** /config | 
...
[**list_function**](DefaultApi.md#list_function) | **GET** /function | 
...
[**weight_recompute**](DefaultApi.md#weight_recompute) | **PUT** /context/weight/recompute | 



## applicable_variants

> models::ApplicableVariantsResponseContent applicable_variants(x_org_id, x_tenant)
...
[**models::ApplicableVariantsResponseContent**](ApplicableVariantsResponseContent.md)
...
> models::BulkOperationOut bulk_operation(x_org_id, x_tenant, bulk_operation_req, x_config_tags)
...
**x_org_id** | **String** |  | [required] |[default to juspay]
**x_tenant** | **String** |  | [required] |
**bulk_operation_req** | [**BulkOperationReq**](BulkOperationReq.md) |  | [required] |
**x_config_tags** | Option<**String**> |  |  |

### Return type

[**models::BulkOperationOut**](BulkOperationOut.md)
...
> models::CreateWorkspaceResponseContent create_workspace(x_org_id, create_workspace_request_content)
...
> models::CreaterOrganisationResponseContent creater_organisation(creater_organisation_request_content)
...
> delete_context(id, x_org_id, x_tenant, x_config_tags)
...
> models::DeleteTypeTemplatesResponseContent delete_type_templates(type_name, x_org_id, x_tenant)
...
[**models::DeleteTypeTemplatesResponseContent**](DeleteTypeTemplatesResponseContent.md)
...
> models::GetConfigResponseContent get_config(x_org_id, x_tenant, prefix, version, body)
...
[**models::GetConfigResponseContent**](GetConfigResponseContent.md)
...
> serde_json::Value get_config_fast(x_org_id, x_tenant)
...
> models::GetOrganisationResponseContent get_organisation(id)
...
> serde_json::Value get_resolved_config(x_org_id, x_tenant, prefix, version, show_reasoning, x_merge_strategy, body)
...
**x_merge_strategy** | Option<[**MergeStrategy**](.md)> |  |  |
**body** | Option<**serde_json::Value**> |  |  |
...
> models::GetTypeTemplatesListResponseContent get_type_templates_list(x_org_id, x_tenant, count, page)
...
> models::ListAuditLogsResponseContent list_audit_logs(x_org_id, x_tenant, count, page, from_date, to_date, table, action, username)
...
**table** | Option<**String**> | Comma serparated list of tables. |  |
**action** | Option<**String**> | Comma serparated list of actions. |  |
**username** | Option<**String**> |  |  |

### Return type

[**models::ListAuditLogsResponseContent**](ListAuditLogsResponseContent.md)
...
> models::ListFunctionResponseContent list_function(x_org_id, x_tenant, count, page)
...
[**models::ListFunctionResponseContent**](ListFunctionResponseContent.md)
...
> models::ListOrganisationResponseContent list_organisation(count, page)
...
> models::ListVersionsResponseContent list_versions(x_org_id, x_tenant, count, page)
...
[**models::ListVersionsResponseContent**](ListVersionsResponseContent.md)
...
> models::ListWorkspaceResponseContent list_workspace(x_org_id, count, page)
...
> models::TestResponseContent test(function_name, stage, x_org_id, x_tenant)
...
------------- | ------------- | ------------- | ------------- | -------------
**function_name** | **String** |  | [required] |
**stage** | [**Stage**](.md) |  | [required] |
**x_org_id** | **String** |  | [required] |[default to juspay]
**x_tenant** | **String** |  | [required] |

### Return type

[**models::TestResponseContent**](TestResponseContent.md)
...
> models::UpdateOrganisationResponseContent update_organisation(id, update_organisation_request_content)
...
> models::UpdateWorkspaceResponseContent update_workspace(workspace_name, x_org_id, update_workspace_request_content)
...
> models::WeightRecomputeResponseContent weight_recompute(x_org_id, x_tenant, x_config_tags)
...
[**models::WeightRecomputeResponseContent**](WeightRecomputeResponseContent.md)
