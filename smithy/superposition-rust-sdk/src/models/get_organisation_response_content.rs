...
pub struct GetOrganisationResponseContent {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
...
impl GetOrganisationResponseContent {
    pub fn new(id: String, name: String, created_by: String, admin_email: String, status: models::OrgStatus, created_at: String, updated_at: String, updated_by: String) -> GetOrganisationResponseContent {
