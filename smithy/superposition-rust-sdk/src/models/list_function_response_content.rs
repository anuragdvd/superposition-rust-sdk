...
pub struct ListFunctionResponseContent {
    ...
    pub data: Option<Vec<models::FunctionResponse>>,
}

impl ListFunctionResponseContent {
    pub fn new() -> ListFunctionResponseContent {
