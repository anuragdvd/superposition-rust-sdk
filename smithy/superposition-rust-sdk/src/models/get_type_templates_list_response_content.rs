...
pub struct GetTypeTemplatesListResponseContent {
    ...
    pub data: Option<Vec<models::TypeTemplatesResponse>>,
}

impl GetTypeTemplatesListResponseContent {
    pub fn new() -> GetTypeTemplatesListResponseContent {
