...
impl FunctionResponse {
    pub fn new(function_name: String, draft_code: String, draft_runtime_version: String, draft_edited_at: String, draft_edited_by: String, last_modified_at: String, last_modified_by: String, change_reason: String, description: String) -> FunctionResponse {
        FunctionResponse {
            function_name,
            published_code: None,
            draft_code,
