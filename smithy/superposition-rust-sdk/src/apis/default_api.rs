...
pub async fn applicable_variants(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str) -> Result<models::ApplicableVariantsResponseContent, Error<ApplicableVariantsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;

    let uri_str = format!("{}/experiments/v2/applicable-variants", configuration.base_path);
...
pub async fn bulk_operation(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, bulk_operation_req: models::BulkOperationReq, x_config_tags: Option<&str>) -> Result<models::BulkOperationOut, Error<BulkOperationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn create_workspace(configuration: &configuration::Configuration, x_org_id: &str, create_workspace_request_content: models::CreateWorkspaceRequestContent) -> Result<models::CreateWorkspaceResponseContent, Error<CreateWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
...
pub async fn creater_organisation(configuration: &configuration::Configuration, creater_organisation_request_content: models::CreaterOrganisationRequestContent) -> Result<models::CreaterOrganisationResponseContent, Error<CreaterOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_context(configuration: &configuration::Configuration, id: &str, x_org_id: &str, x_tenant: &str, x_config_tags: Option<&str>) -> Result<(), Error<DeleteContextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn delete_type_templates(configuration: &configuration::Configuration, type_name: &str, x_org_id: &str, x_tenant: &str) -> Result<models::DeleteTypeTemplatesResponseContent, Error<DeleteTypeTemplatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_config(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, prefix: Option<&str>, version: Option<&str>, body: Option<serde_json::Value>) -> Result<models::GetConfigResponseContent, Error<GetConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_prefix = prefix;
...
pub async fn get_config_fast(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str) -> Result<serde_json::Value, Error<GetConfigFastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn get_organisation(configuration: &configuration::Configuration, id: &str) -> Result<models::GetOrganisationResponseContent, Error<GetOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_resolved_config(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, prefix: Option<&str>, version: Option<&str>, show_reasoning: Option<bool>, x_merge_strategy: Option<models::MergeStrategy>, body: Option<serde_json::Value>) -> Result<serde_json::Value, Error<GetResolvedConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_prefix = prefix;
    ...
    let uri_str = format!("{}/config/resolved", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if let Some(ref param_value) = p_x_merge_strategy {
        req_builder = req_builder.query(&[("x-merge-strategy", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
...
pub async fn get_type_templates_list(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, count: Option<f64>, page: Option<f64>) -> Result<models::GetTypeTemplatesListResponseContent, Error<GetTypeTemplatesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
...
pub async fn list_audit_logs(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, count: Option<f64>, page: Option<f64>, from_date: Option<String>, to_date: Option<String>, table: Option<&str>, action: Option<&str>, username: Option<&str>) -> Result<models::ListAuditLogsResponseContent, Error<ListAuditLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
...
pub async fn list_function(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, count: Option<f64>, page: Option<f64>) -> Result<models::ListFunctionResponseContent, Error<ListFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
...
pub async fn list_organisation(configuration: &configuration::Configuration, count: Option<f64>, page: Option<f64>) -> Result<models::ListOrganisationResponseContent, Error<ListOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_count = count;
    let p_page = page;
...
pub async fn list_versions(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, count: Option<f64>, page: Option<f64>) -> Result<models::ListVersionsResponseContent, Error<ListVersionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
...
pub async fn list_workspace(configuration: &configuration::Configuration, x_org_id: &str, count: Option<f64>, page: Option<f64>) -> Result<models::ListWorkspaceResponseContent, Error<ListWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_count = count;
    let p_page = page;
...
pub async fn test(configuration: &configuration::Configuration, function_name: &str, stage: models::Stage, x_org_id: &str, x_tenant: &str) -> Result<models::TestResponseContent, Error<TestError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_function_name = function_name;
    let p_stage = stage;
    let p_x_org_id = x_org_id;
    ...
    let uri_str = format!("{}/function/{function_name}/{stage}/test", configuration.base_path, function_name=crate::apis::urlencode(p_function_name), stage=p_stage.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn update_organisation(configuration: &configuration::Configuration, id: &str, update_organisation_request_content: Option<models::UpdateOrganisationRequestContent>) -> Result<models::UpdateOrganisationResponseContent, Error<UpdateOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn update_workspace(configuration: &configuration::Configuration, workspace_name: &str, x_org_id: &str, update_workspace_request_content: models::UpdateWorkspaceRequestContent) -> Result<models::UpdateWorkspaceResponseContent, Error<UpdateWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn weight_recompute(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, x_config_tags: Option<&str>) -> Result<models::WeightRecomputeResponseContent, Error<WeightRecomputeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_x_config_tags = x_config_tags;
