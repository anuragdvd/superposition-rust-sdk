...
/// struct for typed errors of method [`applicable_variants`]
...
/// struct for typed errors of method [`bulk_operation`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`get_config_fast`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`get_resolved_config`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`weight_recompute`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn applicable_variants(
    configuration: &configuration::Configuration,
    x_org_id: &str,
    x_tenant: &str,
) -> Result<models::ApplicableVariantsResponseContent, Error<ApplicableVariantsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;

    let uri_str = format!(
        "{}/experiments/v2/applicable-variants",
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApplicableVariantsResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApplicableVariantsResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ApplicableVariantsError> = serde_json::from_str(&content).ok();
...
pub async fn bulk_operation(
    ...
    x_org_id: &str,
    x_tenant: &str,
    bulk_operation_req: models::BulkOperationReq,
    x_config_tags: Option<&str>,
) -> Result<models::BulkOperationOut, Error<BulkOperationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_bulk_operation_req = bulk_operation_req;
    let p_x_config_tags = x_config_tags;

    let uri_str = format!("{}/context/bulk-operations", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_bulk_operation_req);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BulkOperationOut`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BulkOperationOut`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<BulkOperationError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn conclude_experiment(
    ...
    x_org_id: &str,
    x_tenant: &str,
    conclude_experiment_request_content: models::ConcludeExperimentRequestContent,
) -> Result<models::ConcludeExperimentResponseContent, Error<ConcludeExperimentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn create_context(
    ...
    x_org_id: &str,
    x_tenant: &str,
    create_context_request_content: models::CreateContextRequestContent,
    x_config_tags: Option<&str>,
) -> Result<models::CreateContextResponseContent, Error<CreateContextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn create_default_config(
    ...
    x_org_id: &str,
    x_tenant: &str,
    create_default_config_request_content: models::CreateDefaultConfigRequestContent,
) -> Result<models::CreateDefaultConfigResponseContent, Error<CreateDefaultConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateDefaultConfigError> =
...
pub async fn create_dimension(
    ...
    x_org_id: &str,
    x_tenant: &str,
    create_dimension_request_content: models::CreateDimensionRequestContent,
) -> Result<models::CreateDimensionResponseContent, Error<CreateDimensionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn create_experiment(
    ...
    x_org_id: &str,
    x_tenant: &str,
    create_experiment_request_content: models::CreateExperimentRequestContent,
) -> Result<models::CreateExperimentResponseContent, Error<CreateExperimentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn create_function(
    ...
    x_org_id: &str,
    x_tenant: &str,
    create_function_request_content: models::CreateFunctionRequestContent,
) -> Result<models::CreateFunctionResponseContent, Error<CreateFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn create_type_templates(
    configuration: &configuration::Configuration,
    x_org_id: &str,
    x_tenant: &str,
    create_type_templates_request_content: models::CreateTypeTemplatesRequestContent,
) -> Result<models::CreateTypeTemplatesResponseContent, Error<CreateTypeTemplatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateTypeTemplatesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn create_workspace(
    configuration: &configuration::Configuration,
    x_org_id: &str,
    create_workspace_request_content: models::CreateWorkspaceRequestContent,
) -> Result<models::CreateWorkspaceResponseContent, Error<CreateWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
...
pub async fn creater_organisation(
    configuration: &configuration::Configuration,
    creater_organisation_request_content: models::CreaterOrganisationRequestContent,
) -> Result<models::CreaterOrganisationResponseContent, Error<CreaterOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreaterOrganisationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn delete_default_config(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<(), Error<DeleteDefaultConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_key = key;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteDefaultConfigError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn delete_dimension(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<(), Error<DeleteDimensionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        "{}/dimension/{dimension}",
        configuration.base_path,
        dimension = crate::apis::urlencode(p_dimension)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_function(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<(), Error<DeleteFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        function_name = crate::apis::urlencode(p_function_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_type_templates(
    configuration: &configuration::Configuration,
    type_name: &str,
    x_org_id: &str,
    x_tenant: &str,
) -> Result<models::DeleteTypeTemplatesResponseContent, Error<DeleteTypeTemplatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        "{}/types/{type_name}",
        configuration.base_path,
        type_name = crate::apis::urlencode(p_type_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DeleteTypeTemplatesResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DeleteTypeTemplatesResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<DeleteTypeTemplatesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn discard_experiment(
    ...
    x_org_id: &str,
    x_tenant: &str,
    discard_experiment_request_content: models::DiscardExperimentRequestContent,
) -> Result<models::DiscardExperimentResponseContent, Error<DiscardExperimentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn get_config(
...
) -> Result<models::GetConfigResponseContent, Error<GetConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_prefix = prefix;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetConfigResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetConfigResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_config_fast(
    configuration: &configuration::Configuration,
    x_org_id: &str,
    x_tenant: &str,
) -> Result<serde_json::Value, Error<GetConfigFastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;

    let uri_str = format!("{}/config/fast", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetConfigFastError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_context(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<models::GetContextResponseContent, Error<GetContextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn get_context_from_condition(
    ...
    models::GetContextFromConditionResponseContent,
    Error<GetContextFromConditionError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetContextFromConditionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_experiment(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<models::GetExperimentResponseContent, Error<GetExperimentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn get_function(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<models::GetFunctionResponseContent, Error<GetFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_function_name = function_name;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn get_organisation(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::GetOrganisationResponseContent, Error<GetOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_resolved_config(
    ...
    x_merge_strategy: Option<models::MergeStrategy>,
    body: Option<serde_json::Value>,
) -> Result<serde_json::Value, Error<GetResolvedConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_prefix = prefix;
    let p_version = version;
    let p_show_reasoning = show_reasoning;
    let p_x_merge_strategy = x_merge_strategy;
    let p_body = body;

    let uri_str = format!("{}/config/resolve", configuration.base_path);
    let mut req_builder = configuration
        .client
    ...
    if let Some(ref param_value) = p_show_reasoning {
        req_builder = req_builder.query(&[("show_reasoning", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_x_merge_strategy {
        req_builder =
            req_builder.query(&[("x-merge-strategy", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetResolvedConfigError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_type_templates_list(
    configuration: &configuration::Configuration,
    x_org_id: &str,
    x_tenant: &str,
    count: Option<f64>,
    page: Option<f64>,
) -> Result<models::GetTypeTemplatesListResponseContent, Error<GetTypeTemplatesListError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetTypeTemplatesListError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_audit_logs(
    ...
    action: Option<&str>,
    username: Option<&str>,
) -> Result<models::ListAuditLogsResponseContent, Error<ListAuditLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
    ...
    if let Some(ref param_value) = p_table {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListAuditLogsResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListAuditLogsResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_contexts(
    ...
    size: Option<f64>,
    prefix: Option<&str>,
    sort_on: Option<models::ContextFilterSortOn>,
    sort_by: Option<models::SortBy>,
    created_by: Option<&str>,
) -> Result<models::ListContextsResponseContent, Error<ListContextsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_page = page;
...
pub async fn list_default_configs(
    ...
    count: Option<f64>,
    page: Option<f64>,
) -> Result<models::ListDefaultConfigsResponseContent, Error<ListDefaultConfigsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
...
pub async fn list_dimensions(
    ...
    count: Option<f64>,
    page: Option<f64>,
) -> Result<models::ListDimensionsResponseContent, Error<ListDimensionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
...
pub async fn list_experiment(
    ...
    count: Option<f64>,
    all: Option<bool>,
) -> Result<models::ListExperimentResponseContent, Error<ListExperimentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_page = page;
...
pub async fn list_function(
    ...
    count: Option<f64>,
    page: Option<f64>,
) -> Result<models::ListFunctionResponseContent, Error<ListFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListFunctionResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListFunctionResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListFunctionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_organisation(
    configuration: &configuration::Configuration,
    count: Option<f64>,
    page: Option<f64>,
) -> Result<models::ListOrganisationResponseContent, Error<ListOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_count = count;
    let p_page = page;
...
pub async fn list_versions(
    ...
    count: Option<f64>,
    page: Option<f64>,
) -> Result<models::ListVersionsResponseContent, Error<ListVersionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_count = count;
    ...
    let uri_str = format!("{}/config/versions", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListVersionsResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListVersionsResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_workspace(
    ...
    count: Option<f64>,
    page: Option<f64>,
) -> Result<models::ListWorkspaceResponseContent, Error<ListWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_count = count;
    let p_page = page;
...
pub async fn move_context(
    ...
    x_org_id: &str,
    x_tenant: &str,
    move_context_request_content: models::MoveContextRequestContent,
) -> Result<models::MoveContextResponseContent, Error<MoveContextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn publish(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<models::PublishResponseContent, Error<PublishError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_function_name = function_name;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn ramp_experiment(
    ...
    x_org_id: &str,
    x_tenant: &str,
    ramp_experiment_request_content: models::RampExperimentRequestContent,
) -> Result<models::RampExperimentResponseContent, Error<RampExperimentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn test(
    ...
    x_org_id: &str,
    x_tenant: &str,
) -> Result<models::TestResponseContent, Error<TestError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_function_name = function_name;
    let p_stage = stage;
    let p_x_org_id = x_org_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TestResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TestResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_default_config(
    ...
    x_org_id: &str,
    x_tenant: &str,
    update_default_config_request_content: models::UpdateDefaultConfigRequestContent,
) -> Result<models::UpdateDefaultConfigResponseContent, Error<UpdateDefaultConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_key = key;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateDefaultConfigError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn update_dimension(
    ...
    x_org_id: &str,
    x_tenant: &str,
    update_dimension_request_content: models::UpdateDimensionRequestContent,
) -> Result<models::UpdateDimensionResponseContent, Error<UpdateDimensionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_dimension = dimension;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn update_function(
    ...
    x_org_id: &str,
    x_tenant: &str,
    update_function_request_content: models::UpdateFunctionRequestContent,
) -> Result<models::UpdateFunctionResponseContent, Error<UpdateFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_function_name = function_name;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn update_organisation(
    configuration: &configuration::Configuration,
    id: &str,
    update_organisation_request_content: Option<models::UpdateOrganisationRequestContent>,
) -> Result<models::UpdateOrganisationResponseContent, Error<UpdateOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn update_override(
    ...
    x_org_id: &str,
    x_tenant: &str,
    update_override_request_content: models::UpdateOverrideRequestContent,
    x_config_tags: Option<&str>,
) -> Result<models::UpdateOverrideResponseContent, Error<UpdateOverrideError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
...
pub async fn update_overrides_experiment(
    configuration: &configuration::Configuration,
    id: &str,
    x_org_id: &str,
    x_tenant: &str,
    update_overrides_experiment_request_content: models::UpdateOverridesExperimentRequestContent,
) -> Result<
    models::UpdateOverridesExperimentResponseContent,
    Error<UpdateOverridesExperimentError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_update_overrides_experiment_request_content =
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateOverridesExperimentError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn update_type_templates(
    configuration: &configuration::Configuration,
    type_name: &str,
    x_org_id: &str,
    x_tenant: &str,
    update_type_templates_request_content: models::UpdateTypeTemplatesRequestContent,
) -> Result<models::UpdateTypeTemplatesResponseContent, Error<UpdateTypeTemplatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type_name = type_name;
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateTypeTemplatesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn update_workspace(
    ...
    workspace_name: &str,
    x_org_id: &str,
    update_workspace_request_content: models::UpdateWorkspaceRequestContent,
) -> Result<models::UpdateWorkspaceResponseContent, Error<UpdateWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        workspace_name = crate::apis::urlencode(p_workspace_name)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn weight_recompute(
    configuration: &configuration::Configuration,
    x_org_id: &str,
    x_tenant: &str,
    x_config_tags: Option<&str>,
) -> Result<models::WeightRecomputeResponseContent, Error<WeightRecomputeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_x_tenant = x_tenant;
    let p_x_config_tags = x_config_tags;

    let uri_str = format!("{}/context/weight/recompute", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WeightRecomputeResponseContent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WeightRecomputeResponseContent`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<WeightRecomputeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
